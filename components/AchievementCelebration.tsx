...
import { Crown, Sparkles, X, Award, Image as ImageIcon } from 'lucide-react';
...
// Auto-dismisses after 8s but stays interactive.
export function AchievementCelebration({ code, onClose, username }: Props) {
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-[10px] text-neutral-500 leading-relaxed mb-2">
              Download a beautiful 1200x1200 card. Works on any social.
            </p>

            <div className="text-[10px] uppercase tracking-[0.2em] text-neutral-500 font-bold border-t border-neutral-900 pt-3 mt-2">
              {meta.trigger}
            </div>
          </div>
        </div>
